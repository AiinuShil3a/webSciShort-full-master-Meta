<?php
    include "../controller/con_delete_course.php";
?>
<!doctype html>
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid px-4 px-lg-5">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand" href="#"><i class="fas fa-atom"></i> Delete SC Short Courses</a>
            </div>
        </div>
    </nav>
    <br>
    <div class="card text-center">
        <div class="card-header bg-dark text-light">Delete Pass</div>
            <div class="card-body">
                <h1 class="card-title"><i class="fas fa-atom"></i></h1>
                <p class="card-text">
                    คุณได้ทำการลบข้อมูลนี้เรียบร้อยแล้ว
                </p>
                <a href="../index.php" class="btn btn-primary">กลับสู่หน้าหลัก</a>
            </div>
        <div class="card-footer text-muted bg-dark text-light">@outlook.com</div>
    </div>`
