    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid px-4 px-lg-5">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand" href="#"><i class="fas fa-atom"></i> Success SC Short Courses</a>
            </div>
        </div>
    </nav>
    <br>
    <div class="card text-center">
        <div class="card-header bg-dark text-light">Success Pass</div>
            <div class="card-body">
                <h1 class="card-title"><i class="fas fa-atom"></i></h1>
                <p class="card-text">
                    คุณได้ทำการสมัครคอร์สนี้เรียบร้อยแล้ว
                </p>
